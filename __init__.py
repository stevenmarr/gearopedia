...
from setting import FILE_TYPE, CLIENT_ID, APPLICATION_NAME, UPLOAD_FOLDER, UPLOAD_IMG_FOLDER, ALLOWED_EXTENSIONS, \
    ALLOWED_IMG_EXTENSIONS, DATA_BASE, SECRET_KEY
